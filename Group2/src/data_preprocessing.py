...
# df = pd.read_csv(file,skipinitialspace=True,sep=',')
# def data_descriptions(file): 
...
# def preprocessing_and_clean_data(file):
#         # df = pd.read_csv(file,skipinitialspace=True,sep=',')
...
#     # calculate the correllation between all col.
...
# print(data_descriptions(file))
# # print(preprocessing_and_clean_data(file))
# # correlation(file)    
